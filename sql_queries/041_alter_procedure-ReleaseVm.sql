...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            SET ReleasedDate = CASE WHEN VmStatus = 'CheckedOut' THEN GETDATE() ELSE ReleasedDate END,
                VmStatus = CASE WHEN VmStatus = 'CheckedOut' THEN 'Released' ELSE VmStatus END,
