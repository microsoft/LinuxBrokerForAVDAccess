-- Redefines dbo.CheckoutVm so a draining host is never assigned to a new user. The user who
-- already holds it can still reconnect: the reuse path is unchanged.
